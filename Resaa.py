...
satpam.login(token="EptiUb8WA1bCpnjcYZu7.+ZeAF464BWVAWxVRGMjHnW.sOdrzm36+SV380gSK9Nwz3m0HDWYzxKEt+up1BsnJ9c=")
satpam.loginResult()

cl = LINETCR.LINE() #GoblinOne
cl.login(token="EpgvBTNSPN3hrTy4D0m0.49PcThn4vusISstzTYh5ea.rfgPVTDKZ2+gWqT9KO4uGwBdBPezoGeMVBEhvZ524nU=")
cl.loginResult()

ki = LINETCR.LINE() #SamberTwo
ki.login(token="Ep50yBsno9LLoIlBGHfd.4//LFIDfjs7e0LT9exlaRq.N9tea71JP/vaUn6mWqppwlOZIWRLjC+nYw1ph+kmDcU=")
ki.loginResult()

kk = LINETCR.LINE() #GoblinThree
kk.login(token="EpwCovN7l9M1LrYqnrm9.F0WaKTRAPVZ0ULgec57D/q.nAx8RppP4s0K8xucWvnj9ZCwaTpAzGHsw2uut7IshJ8=")
kk.loginResult()

kc = LINETCR.LINE() #SamberFour
kc.login(token="Ep3Z0aXHkPJHSsK73lB6.DuPBR7sykIi7rFjS3UlTLG.Jqlo4uFCz24/4ZSTPCBPfQbO6QHnwNsjQxEQjgXjero=")
kc.loginResult()

ks = LINETCR.LINE() #GoblinFive
ks.login(token="Ep7L7drhOo3sC5Kr0Tu3.KBGyHLGJciIEjlnIti0AyW.PBvW06Fvdkd+TM7XS4fjM/Z1cbXimQVAdzBhEKCAMqk=")
ks.loginResult()

k1 = LINETCR.LINE() #Backup
k1.login(token="EpgvBTNSPN3hrTy4D0m0.49PcThn4vusISstzTYh5ea.rfgPVTDKZ2+gWqT9KO4uGwBdBPezoGeMVBEhvZ524nU=")
k1.loginResult()
...
admin=["uff311a7f8eb86f0bdac17beb82626137"]
owner=["uff311a7f8eb86f0bdac17beb82626137"]
whitelist=["uff311a7f8eb86f0bdac17beb82626137"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
    ...
    #-------------Fungsi Respon Finish---------------------#   
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'uff311a7f8eb86f0bdac17beb82626137'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
