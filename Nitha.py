...
satpam.login(token="EpmsmLsXOxF3zmVgqsV5.erkJzpsA1H1SPEXBYDBtDq.gr8gt3QLdQVsArBmJAZvA7tOZ9wxw5sdOtS7+RvlWMg=")
satpam.loginResult()

cl = LINETCR.LINE() #Luffy
cl.login(token="Ep5totOWYMsQ9LKzoUZ2.23k3BaBfGhKHyCArIoA5iG.awiK4eyJpz2k//sXyy8Yv3k+scGUUnzDCBZUmDZlDaY=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="Ep5totOWYMsQ9LKzoUZ2.23k3BaBfGhKHyCArIoA5iG.awiK4eyJpz2k//sXyy8Yv3k+scGUUnzDCBZUmDZlDaY=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="Ep5totOWYMsQ9LKzoUZ2.23k3BaBfGhKHyCArIoA5iG.awiK4eyJpz2k//sXyy8Yv3k+scGUUnzDCBZUmDZlDaY=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="Ep5totOWYMsQ9LKzoUZ2.23k3BaBfGhKHyCArIoA5iG.awiK4eyJpz2k//sXyy8Yv3k+scGUUnzDCBZUmDZlDaY=")
kc.loginResult()

ks = LINETCR.LINE() #Ussop
ks.login(token="Ep5totOWYMsQ9LKzoUZ2.23k3BaBfGhKHyCArIoA5iG.awiK4eyJpz2k//sXyy8Yv3k+scGUUnzDCBZUmDZlDaY=")
ks.loginResult()

k1 = LINETCR.LINE() #Backup 1
k1.login(token="Eph8pQJS43M3BqaFr0xb.Z2KUEXKG0qIADVzEdWWMAW.N3kkdc5r9MyGJolrtx1HOT6mC22quCSazr9U2BdCUWA=")
k1.loginResult()
...
admin=["u1112a364f49ad61d6ca5ec5bc9d6d375"]
owner=["u1112a364f49ad61d6ca5ec5bc9d6d375"]
whitelist=["u1112a364f49ad61d6ca5ec5bc9d6d375"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""Thx For Add Me (^_^)\nMinat Sewa Bot? Silahkan PM\nIdline: http://line.me/ti/p/~doniagustian1""",
    "lang":"JP",
  ...
  #------Joined User Kick start------#
                    ...
                    if msg.text is not None:
                        ...
                        if data['status'] == 200:
                            if data['result']['result'] == 100:
                                cl.sendText(msg.to, "[Goblin Team & One Piece Chat] " + "\n" + data['result']['response'].encode('utf-8'))
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  mc = "👑 Admin Goblin Team & One Piece Bot 👑\n𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓\n"
                  for mi_d in admin:
              ...
              if owner == []:
                  ...
                  #cl.sendText(msg.to,"Tunggu...")
                  mc = "👑 Goblin Team & Owner One Piece Bot 👑\n𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓\n"
                  for mi_d in owner:
                      mc += "[★]" + cl.getContact(mi_d).displayName + "\n"
                  cl.sendText(msg.to,mc)
